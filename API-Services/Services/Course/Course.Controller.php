<?php
	...
	if(strtoupper($Method)=="POST")
	   { 
	     if(strtoupper($ObjData->Request)=="UPDATEPROGRAMENROLL")	{Course::UpdateProgramEnroll($ObjData->Record);}
		 else if(strtoupper($ObjData->Request)=="UPDATECOLLEGE")	{Course::UpdateCollege($ObjData->Record);}

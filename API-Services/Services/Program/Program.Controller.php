<?php
	...
	if(strtoupper($Method)=="POST")
	   { 
	     if(strtoupper($ObjData->Request)=="SHAKEHAND")		{Program::UpdateProgram($ObjData->Record);}
		 else if(strtoupper($ObjData->Request)=="LOGIN")	{Program::SearchProgram($ObjData->Record);}

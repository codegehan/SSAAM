<?php
     ...
     require_once ("College.Model.php");
	...
	if(strtoupper($Method)=="POST")
	   { 
	     if(strtoupper($ObjData->Request)=="UPDATE")		{College::UpdateCollege($ObjData->Record);}
		 else if(strtoupper($ObjData->Request)=="SEARCH")	{College::SearchCollege($ObjData->Record);}
